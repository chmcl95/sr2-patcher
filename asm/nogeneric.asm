...
; 0x11, a device of no kind, and the game can do nothing with. This
; skips those too, before anything is opened.
;
...
; displaced instructions are done on the way to the continuation. Needs
; dinput8: the type codes are DirectInput 8's.
;
