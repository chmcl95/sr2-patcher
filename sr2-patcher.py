...
PADINPUT_BLOB = bytes.fromhex(
    ...
    '516bc90d8db3a4290000f3a5598b54242485d27402890a31c05f5e5bc21800b8'
    ...
    '102700007605b8102700008984bb9c2100006bc7348d941834210000b90d0000'
    '0066c702000066c74202ff0083c2044975ef8b74241c8b4c242085c9745c8b06'
    '83f80d734f6bd7348d14828d9413342100008b46143d00010000730f85c07434'
    ...
    'c35256575589c58dbba42900006bf0348db4333421000031c931d2520fb70651'
    ...
    '00510fb68c132d210000e844000000594183c6024283fa0472df8db3fc200000'
    'ba120000000fb64601e816000000510fb60ee81c000000594183c6024a75e65d'
    ...
    '0c0000010000008d4319a3edededed8db3842000008dbb34210000b91a000000'
    'f3a5c7839c210000e8030000c783a0210000e80300006a036800000080e8c404'
    '000083f8ff744b89c68d83a42100006a008d8b880c00005168ff0700005056ff'
    '93580c000056ff93640c00008b83880c0000c68418a42100000031c081bba421'
    '0000646973707505b864000000e80200000061c38db418a4210000c783800c00'
    ...
    '00000f8485000000e82d010000e8bd0000008b93840c00008984939c210000eb'
    ...
    '508bb3840c00006bf6348d34968db4333421000058c3e824000000741183f901'
    ...
    'a42100008db3fd060000e87d01000031edc783800c000001000000b00aaab05b'
    ...
    '84ab9c210000e82a010000b00aaa31d20fb68413202100003dff000000746b50'
    'c1e0048db418b41f0000e8fd0000008db382070000e8f2000000586bf5348d34'
    '868db4333421000083bb800c00000175210fb746023dff0000007505b02daaeb'
    ...
    '008db343070000e840000000b00aaa8db3a421000029f76a0468000000c0e8e3'
    ...
    '508b84b39c21000069c0ff7f0000b91027000031d2f7f189c15829c87f0831c0'
    'ba10270000c369c010270000f7d981c1ff7f000031d2f7f13d102700007605b8'
    '10270000ba10270000c38b84b39c210000ba10270000c331c0ba10270000c383'
...
# The actions the exe's screens read as their directions and Enter, which
# are not the steering's: see NOTES.md, *The menus' directions*.
MENU_UP, MENU_DOWN, MENU_LEFT, MENU_RIGHT, MENU_ENTER, MENU_BACK = 9, 10, 11, 12, 6, 1
...
FIXED_PADS = ((2, PAD_UP), (3, PAD_DOWN), (4, PAD_LEFT | MENU_ONLY), (5, PAD_RIGHT | MENU_ONLY),
              ...
              # The exe's own screens - the title, the mode select, the
              # multiplayer lobby and the team room - read their four
              # directions from actions 9-12, not from 2-5, and their
              # Enter from 6 (NOTES.md, *The menus' directions*). So the
              # pad's directions drive those four as well, menu-only,
              # START joins A as an Enter and B is the ESC those screens
              # take as back; the race keeps the camera, the pause, the
              # shifts and the handbrake those actions are in it.
              (MENU_UP, PAD_UP | MENU_ONLY), (MENU_DOWN, PAD_DOWN | MENU_ONLY),
              (MENU_LEFT, PAD_LEFT | MENU_ONLY), (MENU_RIGHT, PAD_RIGHT | MENU_ONLY),
              (MENU_UP, PAD_LS_UP | MENU_ONLY), (MENU_DOWN, PAD_LS_DOWN | MENU_ONLY),
              (MENU_LEFT, PAD_LS_LEFT | MENU_ONLY), (MENU_RIGHT, PAD_LS_RIGHT | MENU_ONLY),
              (MENU_ENTER, PAD_START | MENU_ONLY), (MENU_BACK, PAD_B | MENU_ONLY))
ANNEX_NAME = 16
# The annex's table offsets, as padinput.asm's T_* define them; the
# working area follows at ANNEX_TABLES and ends at ANNEX_END.
T_PADNAMES, T_ACTNAMES, T_DEFAULTS, T_FIXKEYS, T_FIXPADS, T_ORDER, T_FIXACTS = 4096, 4608, 4816, 4920, 4936, 4972, 4985
ANNEX_TABLES, ANNEX_END = 4992, 9856
