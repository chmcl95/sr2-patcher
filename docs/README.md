...
| [NETWORK.md](NETWORK.md) | the multiplayer: what ships (MGNetWk, DirectPlay, the exe's protocol, the race data path, the screens) and the plan for a UDP transport with a directory server |
